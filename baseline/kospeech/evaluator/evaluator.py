...
class Evaluator(object):
    ...
    def evaluate(self, model, audio_paths, save_path):
        ...
        self.search.search(model, eval_queue, self.device, self.print_every)
        os.makedirs(os.path.dirname(save_path), exist_ok=True)
        self.search.save_result(audio_paths, save_path)
