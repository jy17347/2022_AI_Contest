...
from kospeech.checkpoint.earlystopper import EarlyStopper
...
class SupervisedTrainer(object):
    ...
    def __init__(
        ...
        if self.wandb_logging:
            ...
            wandb_username = 'kdpark'
            wandb.init(project=wandb_project_serial, entity=wandb_username, name=train_serial)
    ...
    def train(
        ...
        for epoch in range(start_epoch, num_epochs):
            ...
            row_dict['train_loss'] = train_loss
            row_dict['train_cer'] = train_cer
            ...
            Early stopper
            """
            early_stopping_target = self.config.train.early_stopping_target
            ...
            if self.early_stopper.stop == True:
                logger.info(
                    f"Eearly stopped, coutner {self.early_stopper.patience_counter}/{self.config.train.early_stopping_patience}")

                if self.wandb_logging == True:
